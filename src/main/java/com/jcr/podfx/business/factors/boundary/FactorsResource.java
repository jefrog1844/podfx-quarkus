...
public class FactorsResource {
    ...
    public List<Factor> find(@PathParam("dfmeaId") Long dfmeaId) {
        return Factor.find("DFMEA_ID", dfmeaId).list();
    }
    ...
    @RolesAllowed("read")
    @Produces(MediaType.APPLICATION_JSON)
    public Factor get(@PathParam("dfmeaId") Long dfmeaId,
            @PathParam("factorId") Long factorId) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public void save(@PathParam("dfmeaId") Long dfmeaId,
            FactorDetail input) {
    ...
    public void update(@PathParam("dfmeaId") Long dfmeaId,
            @PathParam("factorId") Long factorId, FactorDetail input) {
        Factor factor = get(dfmeaId, factorId);
        factor.update(input);
    }
