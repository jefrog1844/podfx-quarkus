...
public class FactorsResource {
	...
	public List<FactorDetail> find(@PathParam("dfmeaId") String dfmeaId) {
	...
	@RolesAllowed("read")
	@Produces(MediaType.APPLICATION_JSON)
	public Factor get(@PathParam("dfmeaId") String dfmeaId, @PathParam("factorId") String factorId) {
	...
	@Produces(MediaType.APPLICATION_JSON)
	public void save(@PathParam("dfmeaId") String dfmeaId, FactorDetail input) {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public void update(@PathParam("dfmeaId") String dfmeaId, @PathParam("factorId") String factorId,
			FactorDetail input) {
	...
	@Transactional
	@RolesAllowed("delete")
	public void delete(@PathParam("dfmeaId") String dfmeaId, @PathParam("factorId") String factorId) {
